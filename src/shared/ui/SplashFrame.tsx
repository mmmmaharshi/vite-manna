...
const SplashFrame = ({ children }: SplashFrameProps) => (
  <main className="h-svh w-full container mx-auto max-w-md sm:max-w-lg md:max-w-xl flex items-center justify-center px-6">
    <div className="flex flex-col items-center justify-center w-full">
      <IconSVG width={120} height={120} aria-hidden="true" />
